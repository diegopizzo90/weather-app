...
class TimestampConverterTest {
    ...
    fun toZonedDateTimeTest() {
        val zoneDateTime =
            TimestampConverter.toZonedDateTime("2019-03-04T10:39:37.640Z[UTC]")//dd/MM/yyyy HH:mm-> 04/03/2019 10:39
    ...
    fun fromZonedDateTime() {
        val zoneDateTimeString =
            TimestampConverter.fromZonedDateTime(ZonedDateTime.of(1990, 1, 17, 12, 13, 14, 0, ZoneId.of("UTC")))
